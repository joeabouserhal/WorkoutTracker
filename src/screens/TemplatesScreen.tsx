  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.placeholderCard}>
        ...
        <Text style={styles.cardTitle}>Workout templates are coming soon.</Text>
        <Text style={styles.cardDescription}>
          This page will eventually help you save, organize, and reuse your favorite workout plans.
        </Text>
      </View>
    </ScrollView>
  )
